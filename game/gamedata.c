...
Territory territories[NUM_TERRITORIES] =
{
    ...
    [T_ONTARIO] =               {  .name="Ontario",           .neighbors={ T_NORTHWEST, T_GREENLAND, T_QUEBEC, T_WESTERN_UNITED_STATES, T_EASTERN_UNITED_STATES, -1},    .cardtype=ARTILLERY,  .owner=-1,  .troops=0 },
    ...
    [T_NORTHERN_EUROPE] =       {  .name="Northern Europe",   .neighbors={ T_SCANDINAVIA, T_UKRAINE, T_SOUTHERN_EUROPE, T_WESTERN_EUROPE, T_GREAT_BRITAIN, -1},                       .cardtype=CAVALRY,    .owner=-1,  .troops=0 },
